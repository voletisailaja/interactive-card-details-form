...
<div>
 <img style={{height: "100vh", width: "25%"}} src = "/images/bg-main-desktop.png" alt="desk_img"/>
 
 <img style={{position: "absolute",
    top: "130px",
    left: "160px",}}
     src="/images/bg-card-front.png" alt="front_card"/>
<span id="a" style={{position: "absolute", top: "170px", left: "190px",}}>
...
<h1 style={{color: "white", 
     ...
     bottom: "26rem", 
     left: "11rem", 
     spacing: "2px"}}>{cardNumber}</h1>
     
     <span id="name" style={{position: "absolute", 
     color: "white", 
     bottom: "25rem", 
     left: "11rem", 
     right: "9rem"}}>{cardholderName}</span>
 ...
 <img style={{position: "absolute",
    left: "270px",
    top: "410px"}} src="/images/bg-card-back.png" alt="back_card"/>
...
<div>
  <label htmlFor="cardholderName" style={{display: "block", 
  fontSize: "12px", 
  fontWeight: "bold"}}>CARDHOLDER NAME</label>
...
style={{display: "block",
fontSize: "12px", 
fontWeight: "bold" }}>CARD NUMBER</label>
...
/>
  ...
  style={{display: "block",
  fontSize: "12px", 
  fontWeight: "bold" }}>EXP. DATE (MM/YY)</label>
...
<label htmlFor="cvc" style={{display: "flex"}}>CVC</label>
...
<button type="submit" onClick = {() => setConfirmed(true)}
style={{display: "block", 
margin: "14px 0", 
width: "50%", 
padding: "9px 12px", 
backgroundColor: "hsl(278, 68%, 11%)", 
color: "hsl(0, 0%, 100%)"}}>Submit</button>
...
<br /><br /><br /><br />
<h1 style={{text: "center",left: "4rem",position: "relative"}}>THANK YOU!</h1>
<p style={{left: "4rem", position: "relative", fontSize: "15px"}}>We've added your card details</p>
<br />
